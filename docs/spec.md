...
- **Subject-graph glossary** (issue #29 canon): **subject graph** = the nodes gathered around one selected subject; **subject** = the centered product (the canvas anchor); **linked record** = a metadata record bound to the subject; **related product** = another product sharing a linked record with the subject, shown collapsed with a +N badge until expanded.
